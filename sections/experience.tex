...
\begin{experiences}
  ...
  % Responsibilities
  {
    \begin{cvitems}
      ...
      \item {Building infrastructure using Terraform Cloud and Packer.}
      ...
      \item {Security: Vanta, Bug bounties, SOC2, HIPAA, GDPR, VPNs, Trivy and managing security training.}
  ...
  % Environment
  {
    \begin{cvitems}
      ...
      \item {Microservices architecture using Rancher.}
  ...
  %---------------------------------------------------------
  \expitem
  {Commonwealth Bank of Australia} % Company
  {DevOps Engineer} % Title
  ...
  %---------------------------------------------------------
  \expitem
  {E-Flo Computers} % Company
  {Technical Support Officer} % Title
  ...
  \expitem
  {IBM} % Company
  {Innovations Center Technical Intern} % Title
